 ...
 * @fn				- read_packet
 *
 * @brief			- this function Pops data from the RxFIFO
 ...
 * @fn				- write_packet
 *
 * @brief			- this function writes data to an endpoint
 *
 *
 ...
 *
 * @brief			- this function Configures the RxFIFO of all
 * 					  OUT endpoints.
 *
 ...
 * @parem[in]		- size of the IN endpoint in bytes
 * @return			- none
 ...
 * @fn				- config_endpoint0()
 *
 * @brief			- This function configures the settings of endpoint0
 *
 * @parem[in]		- none
 * @return			- none
 * @note			- none
 ...
 * @fn				- config_endpoint0()
 *
 * @brief			- This function configures the settings of an endpoint
 *
 * @parem[in]		- endpoint
 * @parem[in]		- endpoint Type
 ...
 *
 * @brief			- brief Deconfigures IN
 * 					  and OUT endpoints of a specific endpoint number.
 *
 * @parem[in]		- endpoint_number
 * @return			- none
 * @note			- none
 ...
 * @fn				- USBReset_handler()
 *
 * @brief			- This function Handles the interrupt when reset signal is raised
 *
 * @parem[in]		- none
 * @return			- none
 * @note			- none
 ...
 *
 * @brief			- This function Handles the interrupt when Enumeration
 * 					  signal is raised
 *
 * @parem[in]		- none
 * @return			- none
 ...
 *
 * @brief			- This function Handles the interrupt when RxFiFO
 * 					  signal is raised
 *
 * @parem[in]		- none
 * @return			- none
...
const UsbDriver usb_driver = {
	...
	.set_device_addr = &set_device_address,
	.connect = &connect,
